		...
		public override void OnKill(int timeLeft)
		{
			...
			if (Main.myPlayer == Projectile.owner)
			{
				...
				for (int num161 = 0; num161 < num160; num161++)
				{
					...
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.oldPosition.X + Projectile.width / 2, Projectile.oldPosition.Y + Projectile.height / 2, value12.X, value12.Y, Mod.Find<ModProjectile>("WraithCloud").Type, (int)(Projectile.damage * 0.8), Projectile.knockBack * 0.8f, Projectile.owner, 0f, 0f);
				}
			}
		}
	}

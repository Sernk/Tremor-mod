...
using TremorMod.Content.Items.Placeable.Stone;

namespace TremorMod.Content.Tiles.Stone
{
    public class StoneChestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(8, 91, 146), this.GetLocalization("MapEntry0"), MapChestName);
            AddMapEntry(new Color(8, 91, 146), this.GetLocalization("MapEntry1"), MapChestName);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<StoneChest>();

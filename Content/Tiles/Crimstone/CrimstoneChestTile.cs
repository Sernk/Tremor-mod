...
using TremorMod.Content.Items.Placeable.Crimstone;

namespace TremorMod.Content.Tiles.Crimstone
{
    public class CrimstoneChestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(111, 22, 22), this.GetLocalization("MapEntry0"), MapChestName);
            AddMapEntry(new Color(111, 22, 22), this.GetLocalization("MapEntry1"), MapChestName);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<CrimstoneChest>();

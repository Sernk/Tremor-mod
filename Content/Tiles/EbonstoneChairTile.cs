...
{
    public class EbonstoneChairTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // Names
            AddMapEntry(new Color(121, 14, 203), CreateMapEntryName()); // Цвет на карте
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<EbonstoneChair>();

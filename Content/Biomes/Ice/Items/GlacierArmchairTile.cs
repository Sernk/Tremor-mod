...
namespace TremorMod.Content.Biomes.Ice.Items
{
	public class GlacierArmchairTile : ModTile
	{
        ...
        public override void SetStaticDefaults()
		{
            ...
            AddToArray(ref TileID.Sets.RoomNeeds.CountsAsChair);
			AddMapEntry(new Color(116, 150, 252), CreateMapEntryName());
		}
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<GlacierArmchair>();
        ...
        {
            num = fail ? 1 : 3; //  оличество частиц при разрушении плитки
        }
    }
}

	...
	public class PlagueFlaskEvil : ModProjectile
	{
		...
		public override void OnKill(int timeLeft)
		{
			...
			for (int num221 = 0; num221 < num220; num221++)
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, value17.X, value17.Y, ModContent.ProjectileType<AlchemasterPoisonCloudPro>(), Projectile.damage, 1f, Projectile.owner, 0f, Main.rand.Next(-45, 1));
			}
			//}
		}
